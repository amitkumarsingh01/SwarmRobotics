    ...
    try:
        ...
        while True:
            ...
            if bbox:
                ...
                cv2.putText(frame, f'Center: {bbox_center_x}', (x_min, y_min - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6,
                            (0, 255, 0), 2)

                # Control robot movement based on bounding box position
                if current_time-previous_time>=1:
                    previous_time=current_time
                    if bbox_center_x < frame_center_x - 100:
                        turn_left(50)
                        print("Turning Left")
                    elif bbox_center_x > frame_center_x + 100:
                        turn_right(50)
                        print("Turning Right")
                    else:
                        move_forward(70)
